...
namespace Meta.XR.Movement.Utils
{
    ...
    public class RemoteTransforms : MonoBehaviour
    {
        [BurstCompile]
        ...
        [Header("For test")]
        public CharacterRetargeter target;
        ...
        private void FindBonePairs()
        {
            ...
            var targetTransforms = target._targetBones;
        ...
        public class MirrorTransformsEditor : UnityEditor.Editor
        {
            ...
            {
                base.OnInspectorGUI();
                var remoteTransforms = target as RemoteTransforms;
                if (GUILayout.Button("Find Bone Pairs"))
                {
                    if (remoteTransforms != null)
                    {
                        UnityEditor.EditorUtility.SetDirty(remoteTransforms);
                        UnityEditor.PrefabUtility.RecordPrefabInstancePropertyModifications(remoteTransforms);
                        remoteTransforms.FindBonePairs();
                    }
                }
